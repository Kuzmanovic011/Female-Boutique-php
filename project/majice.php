...
<body> 
    <?php if(isset($_SESSION["porudzbinaGreska"])): ?>
<div class="modal fade" id="prodajaModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php 
            echo $_SESSION["porudzbinaGreska"]; 
            unset($_SESSION["porudzbinaGreska"]);
        ?>
      </div>
...
document.addEventListener("DOMContentLoaded", function() {
    var loginModal = new bootstrap.Modal(document.getElementById('prodajaModal'));
    loginModal.show();
});
</script>
<?php endif; ?>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-left">
        ...
        <li class="nav-item dropdown active">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item active" href="majice.php">Majice</a></li>
...
<div class="container pb-5">
        ...
        <div class="text-center my-5">
              <h2 class="display-4 fw-bold text-light">Majice</h2>
              <hr class="border-danger border-3 w-25 mx-auto opacity-100">
        </div>     
<?php 
  $upit = "SELECT * 
           FROM artikli
           WHERE tipArtikla = 'MAJICA' AND kolicinaArtikla>0";
