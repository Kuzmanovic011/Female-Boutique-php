      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-left">
        ...
        <li class="nav-item dropdown active">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" href="kaputi.php">Kaputi</a></li>
...
<div class="container pb-5">
        ...
        <div class="text-center my-5">
              <h2 class="display-4 fw-bold text-light">Kaputi</h2>
              <hr class="border-danger border-3 w-25 mx-auto opacity-100">
        </div>     
<?php 
  $upit = "SELECT * 
           FROM artikli
           WHERE tipArtikla = 'KAPUT' AND kolicinaArtikla>0";
