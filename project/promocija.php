...
<div class="container-fluid pb-2">
        <div class="container pb-5">
             <div class="text-center my-5">
              <h2 class="display-4 fw-bold text-light">Promocija artikala dana</h2>
              <p class="text-light opacity-75 fs-2">Odabrani artikli su na popustu 20%</p>
    ...
    <strong>Morate biti ulogovani!</strong> Prijavite se da biste videli detalje proizvoda.
    <button type="button" class="btn-close" onclick="zatvoriAlert()"></button>
    </div> 
<?php 
  $upit = "SELECT * 
           FROM artikli
           WHERE kolicinaArtikla>0
           ORDER BY RAND()
           LIMIT 3";
    ...
    <div class="col-md-4 d-flex justify-content-center mb-4">
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <?php $cenaPopust = round($red["cenaArtikla"] *0.8);?>
              <p class="card-text"><?php echo "Cena artikla ~ <i class='text-decoration-line-through'>".$red["cenaArtikla"]."</i><b> $cenaPopust RSD</b>";?></p>
              <form method="POST" action="dodajUKorpu.php">
                ...
                <input type="hidden" name="cenaArtikla" value=<?php echo $cenaPopust;?>>
